...
export default function DashboardInvestor({
  ...
  const t = useTranslations('DashboardInvestor');
  ...
  const rentValue = parseValueFromCurrency(investorDetail.nextRentPaymentCurrency);
  const tokensValue = parseValueFromCurrency(investorDetail.expectedTokensPurchaseCurrency);
  const maintenanceValue = investorDetail.maintenanceExpectedCurrency !== 'R$ 0,00' 
    ? parseValueFromCurrency(investorDetail.maintenanceExpectedCurrency) 
    : 0;
                  ...
                  <table className="py-12 px-6 mb-8 w-full bg-gray-50 rounded-2xl">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="py-2 px-8 text-gray-900 text-right">{investorDetail.nextRentPaymentCurrency}</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td className="py-2 px-8 text-gray-900 text-right">{investorDetail.expectedTokensPurchaseCurrency}</td>
                      </tr>
                      ...
                      {/* <tr>
                        ...
                        {investorDetail.maintenanceExpectedCurrency !== 'R$ 0,00' && (
                          <tr>
                            ...
                            <td className="py-2 px-8 text-gray-900 text-right"> - {investorDetail.maintenanceExpectedCurrency}</td>
                          </tr>
                        )}
        ...
        <div className="w-full md:w-3/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            ...
            >
              ...
              <h3 className="pb-12">
                {t('rentReducedTo1')}
                <span className="font-bold">{investorDetail.nextRentPaymentCurrency}</span>
                {t('rentReducedTo2')}
              </h3>
                ...
                <div className="gauge relative group">
                  <div className="gauge__body">
                    <div
                      ...
                      style={{
                        transform: `rotate(${(investorDetail.rePurchasedTokensPercentMissing || 0) * 180}deg)`,
                      }}
                    ></div>
                    <div className="gauge__cover flex items-center justify-center flex-col">
                      <div className="font-bold text-black text-2xl">{investorDetail.rentYieldFee}</div>
                ...
                <div className="barraP mt-12">
                  <div className="dados flex justify-between">
                    <div className="quantotem text-center pt-4">
                      <div className="font-bold text-sm">{investorDetail.nextRentPaymentCurrency}</div>
                      <div className="font-normal mt-2 text-sm">{t('currentValue')}</div>
                    </div>
                    <div className="quantofalta text-center pt-4">
                      <div className="text-sm">{investorDetail.initRentValueCurrency}</div>
            ...
            >
              ...
              <h3 className="pb-8">
                ...
                <span className="font-bold">{investorDetail.propertyTokensCurrentFormat} tokens</span>{" "}
                {t.rich('accumulatedTokens2', { percent: investorDetail.percentageInvested })}&nbsp;
              </h3>
              <div className="barrinha w-full">
                <div className="gauge relative">
                  <div className="gauge__body">
                    ...
                    ></div>
                    <div className="gauge__cover flex items-center justify-center flex-col">
                      <div className="font-bold text-black text-2xl">{investorDetail.rePurchasedTokensNumberFormat}</div>
                ...
                <div className="barraP mt-12">
                  <div className="dados flex justify-between">
                    <div className="quantotem text-center pt-4">
                      <div className="font-bold text-sm">{investorDetail.propertyTokensCurrentFormat}</div>
                      <div className="font-normal mt-2 text-sm">{t('tokensCurrent')}</div>
                    </div>
                    <div className="quantofalta text-center pt-4">
                      <div className="text-sm">{investorDetail.capitalValueNumberFormat}</div>
