...
const MaintenanceTable: React.FC<Props> = ({ maintenanceList: initialMaintenanceList }) => {
            ...
            {maintenanceList.map((item) => (
              <React.Fragment key={item.maintenanceId}>
                <tr className="hover:bg-gray-50">
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{item.dateCreated}</td>
                  <td className="px-4 py-4 whitespace-normal text-sm text-gray-500">{item.descriptionItem}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{item.priceResolution}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{item.percentBuyer}</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{item.maintenanceAsOwner}</td>
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-center items-center justify-center">
                    <button
                      className="text-xs button-line-transparent px-2 py-1 flex items-right"
                ...
                {/* Boleto dropdown - shows invoice details */}
                {/* {openDropdown === item.invoiceId && (
                  <tr>
                    <td colSpan={7} className="px-4 py-2 bg-gray-50">
                      {isLoading ? (
                        <p className="text-sm text-center py-2">{common("loading")}</p>
                      ) : errorMessage ? (
