...
export default function DashboardLegado({
  investorDetail,
  rentDetail,
  propertyDetail,
  profile
  ...
  const adjustedNextRentPayment = profile === 4 
    ? Math.floor((investorDetail.nextRentPayment / 1000) * 100)  /100
    : investorDetail.nextRentPayment;
  ...
  const adjustedInitRentValue = investorDetail.initRentValue / 10;
  ...
  const adjustedTotalMonthly = profile === 4 
    ? adjustedNextRentPayment + investorDetail.expectedTokensPurchase 
    : null;
  ...
  const adjustedTotalMonthlyCurrency = adjustedTotalMonthly !== null 
    ...
    : investorDetail.totalMonthly;

  // Calcular a porcentagem correta para o gráfico de tokens (tokens atuais / tokens comprados)
  const capitalValueNumber = typeof investorDetail.capitalValueNumberFormat === 'string' 
    ? parseFloat(investorDetail.capitalValueNumberFormat.replace(/\./g, '').replace(',', '.'))
    : investorDetail.capitalValueNumberFormat;
  const tokensCurrentPercentage = capitalValueNumber > 0 
    ? (investorDetail.propertyTokens / capitalValueNumber) 
    : 0;
                  ...
                  <table className="py-12 px-6 mb-8 w-full bg-gray-50 rounded-2xl">
                    <tbody>
                      ...
                      {/* <tr>
                        ...
                        <td className="py-2 px-8 text-gray-900 text-right"> - {investorDetail.calcNextRentPaymentFeeCurrency}</td>
                      </tr> */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                ...
                <div className="gauge relative group">
                  <div className="gauge__body">
                    ...
                    <div className="gauge__cover flex items-center justify-center flex-col">
                      <div className="font-bold text-black text-2xl">{investorDetail.rentYield}</div>
            ...
            >
              ...
              <h3 className="pb-8">
                ...
                {t.rich('accumulatedTokens2Legacy', { percent: investorDetail.percentageInvested })}&nbsp;
              </h3>
              <div className="barrinha w-full">
                ...
                <div className="barraP mt-12">
                  <div className="dados flex justify-between">
                    ...
                    <div className="quantofalta text-center pt-4">
                      <div className="text-sm">{formatNumberWithSeparator(investorDetail.capitalValueNumberFormat)}</div>
