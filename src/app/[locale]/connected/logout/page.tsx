...
export default function ConnectedLogoutPage() {
  ...
  return (
    <main className="flex min-h-[calc(100vh-132px)] flex-1 flex-col items-center justify-center px-10 py-16 text-center">
      ...
      <button type="button" onClick={() => performFirmezaLogout({ router, locale: params?.locale, refresh: true })} className="mt-6 rounded-[10px] border-0 bg-fmz-gold px-7 py-3 font-syne text-[13px] font-bold uppercase tracking-[0.04em] text-fmz-navy transition hover:bg-fmz-gold-dark">Entrar novamente</button>
    </main>
  );
}
