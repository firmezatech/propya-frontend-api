...
const fmzButtonVariantClassNames: Record<FmzButtonVariant, string> = {
  primary: 'w-full rounded-[10px] border-0 bg-fmz-navy px-4 py-3.5 font-syne text-sm font-bold uppercase tracking-[0.05em] text-white hover:-translate-y-0.5 hover:bg-[#162030] hover:shadow-[0_8px_24px_rgba(13,19,33,0.15)] active:translate-y-0',
