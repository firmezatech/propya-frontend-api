...
import type { FmzConnectedDropdownUserSummary } from './fmz-connected-dropdown.types';
...
export const buildFmzConnectedUserSummary = (): FmzConnectedDropdownUserSummary => {
