...
const getFormStringValue = (formData: Record<string, FormDataEntryValue>, fieldName: string): string => String(formData[fieldName] ?? '');
      ...
      <div className="shell">
        <aside className="side">
          ...
          <div>
            ...
            <div className="summary" aria-label="Resumo ilustrativo da carteira">
              <div className="summary-head">
                <div className="sh-l">
                  <span className="sh-dot" />
                  <span className="sh-title">Sua carteira aguardando login</span>
                </div>
                <span className="sh-meta">Última sync · agora</span>
              </div>
              <div className="summary-num">R$ 38.420<span className="cents">,15</span></div>
              <div className="summary-foot">
                <span>Patrimônio tokenizado estimado</span>
                <span className="chip"><TrendingUp aria-hidden="true" /> +2,4% no mês</span>
              </div>
            </div>

            <div className="tokens">
              <div className="tk">
                <div className="tk-thumb"><Home aria-hidden="true" /></div>
                <div className="tk-body"><strong>Residencial Jardim Aurora · 502</strong><span>42 tokens · São Paulo, SP</span></div>
                <div className="tk-right"><div className="v">12,4%</div><div className="k">do imóvel</div></div>
              </div>
              <div className="tk">
                <div className="tk-thumb"><Building2 aria-hidden="true" /></div>
                <div className="tk-body"><strong>Edifício Bela Vista · 1101</strong><span>18 tokens · Campinas, SP</span></div>
                <div className="tk-right"><div className="v">5,8%</div><div className="k">do imóvel</div></div>
              </div>
            </div>
          </div>
        ...
        <main className="form-col">
          <div className="form-inner">
            <div className="fh">
              <span className="fh-eyebrow"><span className="e-ico"><Lock aria-hidden="true" /></span>Acesso seguro</span>
              <h2>Entrar na sua conta</h2>
              <p className="sub">Use seu e-mail e senha para acessar sua moradia, carteira e oportunidades de investimento.</p>
            </div>
            ...
            <form ref={formRef} onSubmit={handleFormSubmit} aria-busy={isSubmitting}>
              <div className="stack">
                ...
                <div className="opt-row">
                  ...
                  <button className="help-link" type="button"><HelpCircle aria-hidden="true" /> Precisa de ajuda?</button>
                </div>
              </div>
            ...
            <div className="signup-nudge">
              <div className="t"><strong>Primeira vez por aqui?</strong><span>Crie sua conta para explorar imóveis e começar sua jornada.</span></div>
