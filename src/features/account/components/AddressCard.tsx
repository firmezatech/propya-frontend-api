...
import { BRAZILIAN_STATES, } from '../domain/account-status-config';
import { formatCepInput } from '../domain/account-formatters';
  ...
  return (
    ...
    >
      <div className={styles.cepRow}>
        <AccountFieldShell label="CEP" className={styles.cepField}>
