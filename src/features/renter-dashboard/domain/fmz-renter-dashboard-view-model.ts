...
export function buildRenterDashboardViewModel(params: {
  ...
  return {
    ...
    acquiredTokensNumber: acquiredTokens,
    remainingToOwnLabel: formatCurrency(remainingToOwn),
    remainingToOwnNumber: remainingToOwn,
    propertyValueNumber: propertyDetail.propertyValue,
